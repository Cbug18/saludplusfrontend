        ...
        <div className="flex flex-col flex flex-col bg-gray-100 ">
            ...
            >
                ...
                <div className='mt-10 mb-10 flex items-center justify-center'>
                    <h1 className="font-serif text-customBlue text-5xl font-bold">Proximas <span className='text-customgray'>Citas</span></h1>
                </div>
                ...
                <div className="overflow-auto rounded-lg shadow hidden md:block">
                    <table className="w-3/5 mx-auto">
                        <thead className="bg-gray-50 border-b-2 border-gray-200">
                            <tr>
                                <th className="w-24 p-3 text-sm font-semibold tracking-wide text-left">Fecha</th>
                                <th className="p-3 text-sm font-semibold tracking-wide text-left">Notas del Doctor</th>
                                <th className="p-3 text-sm font-semibold tracking-wide text-left">Nombre del Paciente</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-gray-100">
                            {appointments.map((appointment) => (
                                <tr key={appointment._id} className="bg-white">
                                    <td className="p-3 text-sm text-gray-700 whitespace-nowrap">{new Date(appointment.dateOfAppointment).toLocaleDateString()}</td>
